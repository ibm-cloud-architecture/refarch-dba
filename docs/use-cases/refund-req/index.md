...
<ArticleCard
    ...
    subTitle="In this demo, you will learn how to handle spikes in demand with straight-through processing through business automation.  Note, this video uses an older version of the use case than the current Getting Started Lab."
...
> Note: you should only continue with these steps if you choose the **Technical deep dive** option listed above in section 2!
