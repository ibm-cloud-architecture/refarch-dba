...
The navigation menu icon (also commonly referred to as the hamburger icon) is used to access the navigation menu and features such as **Browse**, **Search**, **Share**, **Teamspaces**, **Work**, **Cases** and **Reports**.  Additional features can also be added using plugins.  This interface including the the top banner, list of features and menu options are configurable through the use of desktops.
...
You will not specify any searches for the teamspace, click the **Add** button to continue to the next step
...
Download the items below, you will use this later to add the employment application document into the teamspace
...
* Interview Video - <a href="https://ibm.box.com/s/wrg8tk9cx7bi4g23wjk19esxi1rmnl8l" target="_blank">Focus Corp - Video Interview - John Doe - KT.mp4</a>
...
6b. Teamspace Builder - Step 4b - Folders and Documents Tree - Add Document - Employment Application
...
6c. Teamspace Builder - Step 4c - Folders and Documents Tree - Add Document - Interview Video

<br/>

Using the same process as the step above, add the <a href="https://ibm.box.com/s/wrg8tk9cx7bi4g23wjk19esxi1rmnl8l" target="_blank">Interview Video</a> into the **Application / Video Interview** folder.
...
<br/>
 ...
 ![13](./images/320b-Viewer-Redaction-Reason.png)
