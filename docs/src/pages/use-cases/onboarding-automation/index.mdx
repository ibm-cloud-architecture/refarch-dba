...
* Interview Video - [Focus Corp - Video Interview - John Doe - KT.mp4](https://ibm.box.com/s/wrg8tk9cx7bi4g23wjk19esxi1rmnl8l)
...
Using the same process as the step above, add the [interview video](https://ibm.box.com/s/wrg8tk9cx7bi4g23wjk19esxi1rmnl8l) into the **Application / Video Interview** folder.
