...
6a. Teamspace Builder - Folders and Documents Tree
...
6b. Teamspace Builder - Folders and Documents Tree - Add Document - Employment Application
...
6c. Teamspace Builder - Folders and Documents Tree - Add Document - Interview Video
...
7. Teamspace Builder - Select Users
...
[Go to top (Create Teamspace)](#lab-section-4) | [Go to Getting Started Lab](#getting-started-lab)
</p>
</details>
...
Continuing from the previous section, **4.2 Review Teamspace**, you will now review how to view and edit documents.
...
1. From the teamspace, browse to the **Application** folder and right-click on the employment appliction to select the menu option for **Workflow**, **Launch Process**
