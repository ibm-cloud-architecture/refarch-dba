...
11.  Select the **Add document** icon from the top menu bar which will be used to create the separate I9 document
...
<br/>
 ...
 ![13](./images/377-MergeSplit-I9CheckIn.png)
...
<br/>
 ...
 ![13](./images/377-MergeSplit-EmployeeApp.png)

<br/>

Congratulations, we have now completed the **View and Edit Documents** steps.  You can now exit the document viewer to return back to the **Teamspace**.
