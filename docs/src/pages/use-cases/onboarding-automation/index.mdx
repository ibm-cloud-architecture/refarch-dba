...
This optional section covers preparing the following content in your teamspace so that it ready for target lab sections (identified below) of this lab:

<br/>

* **Employment Application**: prepare the document with initial annotations for target lab section **5 - View and Edit Documents**
  * If you do not complete this section, you can use the diagrams in the target lab section to view the annotations.  The target lab section also includes the creation of annotations.

<br/>

* **Video Interview**: prepare the video with intial bookmarks for target lab section **7 - Review Video**.
  * If you do not complete this section, you can use the diagrams in the target lab section to view the bookmarks and complete the last step to create additional bookmarks.
...
> Note: this section assumes familiarity with the creation of annotations.  If this is not the case, please review the target lab section first and then come back to this section.

You will create annotations to the application document in prepartion for section **5 - View and Edit Documents** (target lab section)
...
You will create video bookmarks to the video interview in prepartion for section **7 - Review Video** (target lab section)
