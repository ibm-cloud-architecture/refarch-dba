...
> ﹡ &nbsp; &nbsp; **Sections identified with a ﹡ indicates that the section is optional**
...
2. Administrator Users, expand the following section to access additional steps to setup access for yourself and others in your environment:
...
9. When ready, click the **Onboarding Automation** tile to launch the demo.
...
2. Using the diagram below as a reference, create the following annotations/comments:
    ...
    1. Highlight annotation on the salary desired amount (85,000)
