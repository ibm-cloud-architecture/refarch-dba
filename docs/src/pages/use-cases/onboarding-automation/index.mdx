...
As displayed in the diagram below, the **Add Document** window appears. Confirm the **Class** property is set to **Document** and update the **Document Title** property to **John Doe - I9**.  Next, click the **Add** button to add the document.

<br/>

 ![13](./images/375B-MergeSplit-DocSave.png)
