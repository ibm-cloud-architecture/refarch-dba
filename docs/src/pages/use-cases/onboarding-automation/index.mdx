...
**Choose an option:**
 ...
 ![10](./images/110-Navigator-OnboardedEmployees.png)
...
#### Business acceleration is often determined by an information worker's ability to access the right content at the right time to make the right decision and that's why IBM developed IBM Navigator.
...
Open the Onboarding Automation app which opens the IBM Navigator user interace

<br/>
IBM Navigator is essentially a desktop for an organization's workers  to find and organize information.
