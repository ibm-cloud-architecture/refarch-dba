...
> *Note: this section is optional and section covers preparing the following content in your teamspace.

* **Employment Application**: prepare the document with initial annotations for lab section **5 - View and Edit Documents**
  * If you do not complete this section, you can use the diagrams in the target lab section to view the annotations.
