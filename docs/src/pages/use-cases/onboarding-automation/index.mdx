...
> ﹡ &nbsp; &nbsp; **Sections identified with a ﹡ indicates that the section may require more technical background and should be skipped for sales professionals**
...
2. Using the diagram below as a reference, create the following annotations/comments:
    ...
    1. Document comment with comment: Salary request exceeds job posting - please review
