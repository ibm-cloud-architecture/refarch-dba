...
Please login to IBM Technology Zone and navigate to https://techzone.ibm.com/collection/business-automation-saas to reserve an environment.  

<br/>
Once you have access to an environment, please continue here:

1\. Enablement Users, your environment should already be completed, please continue.  
...
<a name="additional-assets-200"></a>
<br/>
<details>
<summary>200 - Containers for Fast Deployment and Flexibility</summary>

<br/>

Video: <a href="https://youtu.be/IfuyERN_X9E" target="_blank">Containers for Fast Deployment and Flexibility (6:47)</a>

<br/>

![13](./images/additional-assets/ContainersFastDeploymentFlexibility.png)

<br/>

IBM's Kevin Trinh offers a succinct introduction to containers and how they make deployment and updates faster and easier for IT organizations.
...
Video: <a href="https://youtu.be/IfuyERN_X9E" target="_blank">Automate End-to-End Workflows (4:40)</a>
...
To learn more:  
Visit <a href="http://ibm.biz/business-automation-workflow" target="_blank">ibm.biz/business-automation-workflow</a>  
Review this commissioned ROI study conducted by Forrester Consulting: http://ibm.biz/TEI-automation  
