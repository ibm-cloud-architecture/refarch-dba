...
**Use Case:** Content and documents services
...
6. When ready, click the green **Onboarding Automation** tile to launch the demo.
...
Please note that the folder can be selected by either clicking on the checbox -OR- by clicking on the folder row.  If a checkbox is not visible, contact your administrator to enable **Content list checkboxes** at the desktop level.  Clicking on the folder name text will select the folder and additionally traverse into the folder.
...
This optional section covers preparing the following content in your teamspace so that it ready for target sections of this lab:

<br/>

* **Employment Application**: prepare the document with initial annotations for target section **5 - View and Edit Documents**.
  * If you do not complete this section, you can use the diagrams in the target section to view the annotations.  The target section also includes the creation of annotations.

<br/>

* **Video Interview**: prepare the video with intial bookmarks for target section **7 - Review Video**.
  * If you do not complete this section, you can use the diagrams in the target section to view the bookmarks and complete the last step to create additional bookmarks.
...
> Note: this section assumes familiarity with the creation of annotations.  If this is not the case, please review the target section first and then come back to this section.

You will create annotations to the application document in prepartion for section **5 - View and Edit Documents** (target section)
...
2. Although not necessary, the viewing of annotations such as stamps and comments is better represented when they are created by different users.  If you have access to multiple user accounts, please use the following as a reference when creating annotations and comments in the next step.
    1. User 1 (Carly) - HR Preprocessor
    1. User 2 (Dave) - HR Reviewer
    1. User 3 (Lucy) - HR Approver (your primary user account)

<br/>

If you do not have access to multiple user accounts, please your primary user account to create all the annotations and comments.

<br/>

3. Using the diagram below as a reference please note the following annotations/comments that will be create:
    1. Redaction annotation on the Social Security Number with redaction reason **Social Security Number**
    1. Highlight annotation on the salary desired amount (85,00)
    1. Sticky note annotation with text: Salary request exceeds job posting - please review
    1. Text annotation with text: Salary request exceeds job posting - please review
    1. Stamp annotation with the **Received date** stamp
    1. Document comment with comment: Salary request execeeds job posting - please review
    1. Stamp annotation with the **Reviewed date** stamp
    1. Document comment with comment: Salary adjust was approved, please proceed with this candidate
    1. Document comment with comment: This is a test comment, right-click this comment and select Edit/Delete to edit or delete this comment

<br/>

If you will only be using one user account, create the annotations/comments in any order above.
If you are using multipe user accounts, create items a - f using User 1 (Carly) first.  Next, using User 2 (Dave) - create items g and h.  Lastly, using User 4 (Lucy) - create item i.
...
You will create video bookmarks to the video interview in prepartion for section **7 - Review Video** (target section)
...
These are the bookmarks that should be created:
  1. Tell me about yourself (00:00:07)
  1. Why shoud we hire you? (00:00:31)
  1. Why did you leave your last job? (00:00:51)
  1. What is your greatest weakness? (00:01:05)
  1. What are your greatest strength? (00:01:21)
  1. Where do you see yourself in 5 years? (00:01:42)
  1. What do you like to do outside of work? (00:01:57)
...
> *Note: this section is optional, if you do not want to perform this section, please proceed to the next section.
...
> *Note: this section is optional, if you do not want to perform this section, please proceed to the next section.  If you perform this section, please review section [4.3.2 Prepare Video Interview](#lab-section-432) to prepare the video with bookmarks.
