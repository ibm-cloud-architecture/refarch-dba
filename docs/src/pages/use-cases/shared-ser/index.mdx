...
<strong>Updated 2021-02-16</strong> - Development in progress
</InlineNotification>
...
<ArticleCard
    color="dark"
    title="PENDING - Demo Video - Shared Services Request"
    subTitle="PENDING - In this demo, you will learn how to use lightweight workflows to manage incoming requests"
    href="https://ibm.com"
...
As the Workstream Supervisor, you are now ready to create a new workstream and publish it so the departments you work with, such as Accounts Payable and HR, can submit their requests in an organized manner.
...
After reviewing the demo launch page including the outline and discovery map, we are ready to launch the Workstream Supervisor's Workplace interface, the single place you manage all your work.
