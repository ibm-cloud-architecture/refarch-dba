...
1. Use Case Overview
1. [Customer] Submit some refunds
1. [Refund Investigator] Complete the investigation task
1. [Business Analyst] Review the week 1 Operations Dashboard
1. [Rule Manager] Improve the business rules
1. [Customer] Test the new business rules
1. [Business Analyst] Review the week 2 Operations Dashboard
