...
10. You have the following options to navigate the Refund Request use case:
    ...
    1. **Guided or Live Walkthrough**: you may wish to have the application provide you with a single page view of the use case across multiple steps so you do not have to go to multiple interfaces.
