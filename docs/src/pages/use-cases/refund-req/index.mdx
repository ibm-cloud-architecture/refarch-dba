...
1. Use Case Overview
1. Customer persona - submit some refunds
1. Refund Investigator persona - complete the investigation task
1. Business Analyst persona - review the week 1 Operations Dashboard
1. Rule Manager persona - improve the business rules
1. Customer persona - test the new business rules
1. Business Analyst persona - review the week 2 Operations Dashboard
...
10. You have the following options to navigate the Refund Request use case:
    1. **Technical deep dive**: the default interface is configured for experienced users who explore using the launchpad that provides easy access to the product interfaces for each part of the use case.
    1. **Guided or Live Walkthrough**: you may wish to have the application provide you with a single page view of the use case across multiple steps so you do not have to go to mulitple interfaces.
...
11. If you chose the **Technical deep dive** option, continue to use the below documentation and explore.
...
1. Navigate to the **Run the demo!** tab and then click on the picture of the **Customer**
...
1. Review the data used to make the decisions
...
3. Depending on your platform you may see one or more of the new Workplace interface or Navigator's Work Dashboard or Process Portal (below will use Navigator's Work Dashboard)
...
5. Review the list of tasks and click on the most recent Investigation task to claim it
