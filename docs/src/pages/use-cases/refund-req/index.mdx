...
10. You have the following options to navigate the Refund Request use case:
    ...
    2. **Guided or Live Walkthrough**: you may wish to have the application provide you with a single page view of the use case across multiple steps so you do not have to go to multiple interfaces.
...
6. When ready, click the **Refund Request** tile to launch the use case
...
4. Review the week 1 dashboard metrics and note the following:
    ...
    2. The high time for average manual investigation processing (~120 minutes)
...
4. Review the dashboard metrics and note the following
    ...
    2. a lower time for average manual investigation processing (~60 minutes)
